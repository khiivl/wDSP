...
3. If you want to disable the stock DSP app, run the: 'adb shell pm disable com.qf.soundeffects' command to disable it. Use 'adb shell pm enable com.qf.soundeffects' to enable it back.
