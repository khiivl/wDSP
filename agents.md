...
- 🧩 **Виправлення**:
  ...
  5. **Акустичний ліміт зрізу високих**: у `SweepMeasurement::synthesizeAutoEq16` для частот $> 1\text{ кГц}$ максимальний зріз обмежено до $-3.0\text{ дБ}$ (мінімальний індекс `4` замість `1`), що фізично унеможливлює знищення верхів та мовної присутності.
