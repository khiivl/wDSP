...
- **Калібрування мікрофона й автопресет** (типово: свіжа установка, рута немає): попередження й
  ...
  через adb не заборонили мікрофон сервісу **TXZ**, а **Toppal** при цьому глухим не став — має свій
  шлях до мікрофона. Вікна від них не чекати (`platform/05-AUDIO-PATH.md`, вендорні асистенти).
