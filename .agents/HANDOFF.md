...
1. **Вікно аналізу 341 мс → RT60-залежне 30–50 мс.** Найбільший розрив із документом і водночас
   друга причина розкиду в нижніх смугах (§6 п.12). Потрібна оцінка RT60 — документ пропонує MLE по
   дифузному хвосту.
