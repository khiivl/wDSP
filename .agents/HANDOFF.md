...
3. **Тест тоном**: `Music/tone_1k_10k_48k.wav` (1 і 10 кГц, −20 dBFS, 48 кГц) уже на апараті. Власник
   ставить → дамп → тони на 1000/10000 Гц (частота Visualizer правильна) чи на 919/9188 (брати
   частоту від мікшера). Висновок змінює всю шкалу.
...
8. ⚠️ Гучність: до виміру AS_PLAYED стояла **6**, я лишив **2** (межа власника 5).
