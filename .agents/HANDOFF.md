...
- **Калібрування мікрофона й автопресет** (типово: свіжа установка, рута немає): попередження й
  ...
  зараз недоступний на повну смугу»**. Причина: вендорний асистент **Toppal**, за переконанням
  власника, забирає мікрофон назавжди, і вікна від нього не буде. ❓ Не виміряно (на Haiwai Toppal
  немає, на Jitu2 є) — поведінку Toppal не вигадувати, міряти на Jitu2.
