...
## 🔴🔴 15.09.2026, ранок — ЗРІЗ СЕСІЇ (читати ЦЕ першим; попередні розділи — історія)
...
- ⚠️ Лишилось: на 640 у нижній пілюлі обрізається останній підпис «Налаштування» (на 768 цілий). Не чіпано.
...
- Зроблено (`c8cf5d9`, `ec…` див. `git log`): три перевірки прибрано; навігатор за замовчуванням додається у список
