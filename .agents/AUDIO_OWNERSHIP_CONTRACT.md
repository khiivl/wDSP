...
| 🔴🔴 **помилка `saved_vol` НЕ МАЄ СТАЛОГО ЗНАКУ — вона вміє робити ГУЧНІШЕ** | 📻 | 📻 | 08.09: `saved_vol=5` проти живих `9` ⇒ чіп **тихіше** на 4 кроки. 09.09, той самий апарат, інший стан: `saved_vol=5` проти живих `2` ⇒ чіп **гучніше** на 3. 🔴 Тобто це не «радіо трохи тихше після перемикання», як ми обидва думали вчора: залежно від того, на чому заморозилось поле, віддача або взяття тракту може **підняти** гучність без участі людини. Напрямок задає не логіка, а те, яким `saved_vol` лишився з часів останнього проходу фалбек-гілки — тобто число, яке ніхто не веде і ніхто не бачить. ⚖️ Це міняє вагу питання для власника: тихіше — незручність, гучніше в машині — інша категорія. ✍️ Розворот знайдено стороною QFRadio 09.09 при перевірці на прохання wDSP; учорашній вимір робився в одному стані й знаку показати не міг |
