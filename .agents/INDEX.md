...
| [RESEARCH_REQUEST_DYNAMIC_BASS.md](RESEARCH_REQUEST_DYNAMIC_BASS.md) | 🔬 open research request (14.09.2026): should bass compensation and the midbass high-pass track listening level, expressed in the hardware's own coarse steps. The answer goes to `RESEARCH_RESULT_DYNAMIC_BASS.md` |
